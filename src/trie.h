...
#ifndef deepinvte_trie_h_included
#define deepinvte_trie_h_included
...
struct _deepinvte_trie *_deepinvte_trie_new(void);

/* Free a trie structure. */
void _deepinvte_trie_free(struct _deepinvte_trie *trie);

/* Add a string to the trie, along with its associated result and an optional
 * Quark to store with it. */
void _deepinvte_trie_add(struct _deepinvte_trie *trie,
...
const char *_deepinvte_trie_match(struct _deepinvte_trie *trie,
...
void _deepinvte_trie_print(struct _deepinvte_trie *trie);

extern const struct _deepinvte_matcher_class _deepinvte_matcher_trie;
