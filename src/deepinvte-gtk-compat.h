...
#ifndef deepinvte_gtk_compat_h_included
#define deepinvte_gtk_compat_h_included
...
#define DeepinvteRegionRectangle cairo_rectangle_int_t
...
#define DeepinvteRegionRectangle GdkRectangle
